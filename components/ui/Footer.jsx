...
//           </div>
//    */}
// " className="hover:text-pink-800 transition">Privacy</a>
//           </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col space-y-3 text-center">
              {[
                ...
                { name: "Features", href: "https://github.com/Luckifer69/AI-Mock-Interview.git" },
                { name: "Contact", href: "https://www.linkedin.com/in/Luckifer/" },
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex space-x-6">
              {[
                { 
                  name: "GitHub", 
                  href: "https://github.com/Luckifer69/AI-Mock-Interview.git",
                  icon: (
                ...
                { 
                  name: "LinkedIn", 
                  href: "https://www.linkedin.com/in/Luckifer/",
                  icon: (
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
